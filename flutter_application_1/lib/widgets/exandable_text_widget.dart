...
class _ExandableTextWidgetState extends State<ExandableTextWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: secondHalf.isEmpty?SmallText(color:AppColor.paraColor, size: Dimensions.font20, text: firsrHalf):Column(
        children: [
          SmallText(height: 1.8, color:AppColor.paraColor, size: Dimensions.font20, text: hiddenText?(firsrHalf+"..."):(firsrHalf+secondHalf)), 
          InkWell(
            onTap: (){
              setState(() {
